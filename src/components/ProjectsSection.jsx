    ...
    <section id="projects" className="py-24 px-4 relative">
      <div className="container mx-auto max-w-5xl">
        ...
        <p className="text-center text-muted-foreground mb-12 max-w-2xl mx-auto">
         Here are a few projects I’ve worked on, showcasing my backend skills with Python and Flask. Each project emphasizes clean server-side logic, data management, and functional user interfaces.
        </p>
